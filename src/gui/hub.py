...
class Hub:
    ...
    def _build_header(self):
        ...
        badge = ctk.CTkFrame(header, fg_color=CARD_BG,
    ...
    def _build_dashboard_panel(self):
        ...
        if w_list:
            for w in w_list:
                ctk.CTkLabel(panel, text=w, text_color=GOLD,
    ...
    def _setting_row_player_tag(self, parent):
        ...
        ctk.CTkLabel(row, text="Player Tag (#tag)", font=(FONT_FAMILY, S(12)),
    ...
    def _build_history_content(self, parent):
        ...
        for brawler, stats in self.match_history.items():
            ...
            ctk.CTkLabel(stats_f, text=f"{lr}%", font=(FONT_FAMILY, S(11), "bold"),
                         text_color=ACCENT).pack(side="left", padx=S(3))
